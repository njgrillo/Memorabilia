...
public class SiteMemorabiliaRepository
    : MemorabiliaRepository<Entity.Memorabilia>, ISiteMemorabiliaRepository
{
    public SiteMemorabiliaRepository(MemorabiliaContext context, IMemoryCache memoryCache)
