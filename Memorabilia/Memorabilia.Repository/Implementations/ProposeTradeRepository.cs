    ...
    : MemorabiliaRepository<Entity.ProposeTrade>, IProposeTradeRepository
{
    ...
    public async Task<Entity.ProposeTrade[]> GetAllAccepted(int userId)
    ...
    public async Task<Entity.ProposeTrade[]> GetAllExpired()
    ...
    public async Task<Entity.ProposeTrade[]> GetAllOpen(int? userId = null)
