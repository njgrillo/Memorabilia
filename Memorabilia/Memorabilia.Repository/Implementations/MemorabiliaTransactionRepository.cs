                                                                                      ...
                                                                                      MemorabiliaSearchCriteria memorabiliaSearchCriteria = null)
    {
        var query =
            ...
            where memorabiliaTransaction.UserId == userId
              ...
              && (memorabiliaSearchCriteria.AutographFilter == Constant.AutographFilter.None || (memorabiliaSearchCriteria.AutographFilter == Constant.AutographFilter.WithAutographs && memorabilia != null && memorabilia.Autographs.Any()) || (memorabiliaSearchCriteria.AutographFilter == Constant.AutographFilter.WithoutAutographs && memorabilia != null && !memorabilia.Autographs.Any()))
              ...
              && (memorabiliaSearchCriteria.AutographSearchCriteria.AuthenticationFilter == Constant.AuthenticationFilter.None || (memorabiliaSearchCriteria.AutographSearchCriteria.AuthenticationFilter == Constant.AuthenticationFilter.NotAuthenticated && memorabilia != null && memorabilia.Autographs.Any(autograph => !autograph.Authentications.Any())) || (memorabiliaSearchCriteria.AutographSearchCriteria.AuthenticationFilter == Constant.AuthenticationFilter.Authenticated && memorabilia != null && memorabilia.Autographs.Any(autograph => autograph.Authentications.Any())))
              ...
              && (memorabiliaSearchCriteria.AutographSearchCriteria.ImageFilter == Constant.ImageFilter.None || (memorabiliaSearchCriteria.AutographSearchCriteria.ImageFilter == Constant.ImageFilter.NoImages && memorabilia != null && memorabilia.Autographs.Any(autograph => !autograph.Images.Any())) || (memorabiliaSearchCriteria.AutographSearchCriteria.ImageFilter == Constant.ImageFilter.Images && memorabilia != null && memorabilia.Autographs.Any(autograph => autograph.Images.Any())))
              && (memorabiliaSearchCriteria.AutographSearchCriteria.InscriptionFilter == Constant.InscriptionFilter.None || (memorabiliaSearchCriteria.AutographSearchCriteria.InscriptionFilter == Constant.InscriptionFilter.NoInscription && memorabilia != null && memorabilia.Autographs.Any(autograph => !autograph.Inscriptions.Any())) || (memorabiliaSearchCriteria.AutographSearchCriteria.InscriptionFilter == Constant.InscriptionFilter.Inscription && memorabilia != null && memorabilia.Autographs.Any(autograph => autograph.Inscriptions.Any())))
              && (!memorabiliaSearchCriteria.AutographSearchCriteria.People.Any() || memorabilia != null && memorabilia.Autographs.Any(autograph => memorabiliaSearchCriteria.AutographSearchCriteria.PersonIds.Contains(autograph.PersonId)))
              ...
              && (!memorabiliaSearchCriteria.AutographSearchCriteria.Teams.Any() || memorabilia != null && memorabilia.Autographs.Any(autograph => autograph.Person.Teams.Select(team => team.TeamId).Any(teamId => memorabiliaSearchCriteria.AutographSearchCriteria.TeamIds.Contains(teamId))))
              ...
              && (memorabiliaSearchCriteria.ImageFilter == Constant.ImageFilter.None || (memorabiliaSearchCriteria.ImageFilter == Constant.ImageFilter.NoImages && memorabilia != null && !memorabilia.Images.Any()) || (memorabiliaSearchCriteria.ImageFilter == Constant.ImageFilter.Images && memorabilia != null && memorabilia.Images.Any()))
              ...
              && (!memorabiliaSearchCriteria.People.Any() || memorabilia != null && memorabilia.People.Any(person => memorabiliaSearchCriteria.PersonIds.Contains(person.PersonId)))
              ...
              && (!memorabiliaSearchCriteria.Teams.Any() || memorabilia != null && memorabilia.Teams.Any(team => memorabiliaSearchCriteria.TeamIds.Contains(team.TeamId)))
