...
public partial class TeamTimeline
{
    ...
    [Parameter]
    public bool DisplayConference { get; set; } 
        = true;
    ...
    [Parameter]
    public Severity TeamChampionshipEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color TeamChampionshipEditColor { get; set; } 
        = Color.Info;

    [Parameter]
    public Severity TeamConferenceEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color TeamConferenceEditColor { get; set; } 
        = Color.Info;

    [Parameter]
    public Severity TeamDivisionEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color TeamDivisionEditColor { get; set; } 
        = Color.Info;

    [Parameter]
    public Severity TeamEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color TeamEditColor { get; set; } 
        = Color.Info;
    ...
    [Parameter]
    public Severity TeamLeagueEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color TeamLeagueEditColor { get; set; } 
        = Color.Info;
