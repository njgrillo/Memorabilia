...
public partial class PersonTimeline
{
    [Inject]
    ...
    [Parameter]
    public Severity PersonAccoladeEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color PersonAccoladeEditColor { get; set; } 
        = Color.Info;

    [Parameter]
    public Severity PersonEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color PersonEditColor { get; set; } 
        = Color.Info;

    [Parameter]
    public Severity PersonHallOfFameEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color PersonHallOfFameEditColor { get; set; } 
        = Color.Info;
    ...
    [Parameter]
    public Severity PersonImageEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color PersonImageEditColor { get; set; } 
        = Color.Info;

    [Parameter]
    public Severity PersonOccupationEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color PersonOccupationEditColor { get; set; } 
        = Color.Info;

    [Parameter]
    public Severity PersonSportServiceEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color PersonSportServiceEditColor { get; set; } 
        = Color.Info;
    ...
    [Parameter]
    public Severity PersonTeamEditAlertSeverity { get; set; } 
        = Severity.Info;
    ...
    [Parameter]
    public Color PersonTeamEditColor { get; set; } 
        = Color.Info;
