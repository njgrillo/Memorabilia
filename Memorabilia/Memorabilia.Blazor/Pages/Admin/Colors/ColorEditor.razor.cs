...
public partial class ColorEditor : ComponentBase, IEditDomainItem
{
    [Inject]
    ...
    {
        ViewModel = new SaveDomainViewModel(await QueryRouter.Send(new GetColor.Query(Id)).ConfigureAwait(false),
                                             DomainTypeName,
                                             ImagePath,
                                             NavigationPath);
    }
