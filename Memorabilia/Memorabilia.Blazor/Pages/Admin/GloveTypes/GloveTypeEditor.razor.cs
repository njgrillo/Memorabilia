...
public partial class GloveTypeEditor : ComponentBase, IEditDomainItem
{
    [Inject]
    ...
    {
        ViewModel = new SaveDomainViewModel(await QueryRouter.Send(new GetGloveType.Query(Id)).ConfigureAwait(false),
                                             DomainTypeName,
                                             ImagePath,
                                             NavigationPath);
    }
