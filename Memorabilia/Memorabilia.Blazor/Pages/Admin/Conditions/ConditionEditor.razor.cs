...
public partial class ConditionEditor : ComponentBase, IEditDomainItem
{
    [Inject]
    ...
    {
        ViewModel = new SaveDomainViewModel(await QueryRouter.Send(new GetCondition.Query(Id)).ConfigureAwait(false),
                                             DomainTypeName,
                                             ImagePath,
                                             NavigationPath);
    }
