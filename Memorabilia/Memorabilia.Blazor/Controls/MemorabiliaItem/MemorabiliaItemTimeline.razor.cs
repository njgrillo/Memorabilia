...
namespace Memorabilia.Blazor.Controls.MemorabiliaItem
{
    public partial class MemorabiliaItemTimeline : ComponentBase
    {
        ...
        [Parameter]
        public Severity MemorabiliaEditDetailAlertSeverity { get; set; } = Severity.Info;

        [Parameter]
        public string MemorabiliaEditDetailAlertTitle { get; set; }

        [Parameter]
        public Color MemorabiliaEditDetailColor { get; set; } = Color.Info;

        [Parameter]
        public Severity MemorabiliaEditImageAlertSeverity { get; set; } = Severity.Info;

        [Parameter]
        public string MemorabiliaEditImageAlertTitle { get; set; }

        [Parameter]
        public Color MemorabiliaEditImageColor { get; set; } = Color.Info;

        [Parameter]
        public Severity MemorabiliaEditItemAlertSeverity { get; set; } = Severity.Info;

        [Parameter]
        public string MemorabiliaEditItemAlertTitle { get; set; }

        [Parameter]
        public Color MemorabiliaEditItemColor { get; set; } = Color.Info;
