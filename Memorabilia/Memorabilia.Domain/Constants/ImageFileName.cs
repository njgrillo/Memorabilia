...
{
    public static string AccomplishmentTypes 
        => "accomplishmenttypes.jpg";
    ...
    public static string AuthenticationCompanies 
        => "authenticationcompanies.jpg";

    public static string Autographs 
        => "autographs.jpg";

    public static string AwardTypes 
        => "awardtypes.jpg";

    public static string Bammer 
        => "bammertypes.jpg";

    public static string BaseballTypes
        => "baseballtypes.jpg";
    ...
    public static string BasketballTypes 
        => "basketballtypes.jpg";

    public static string Bat 
        => "bat.jpg";

    public static string BatTypes 
        => "battypes.jpg";

    public static string Bobblehead 
        => "bobblehead.jpg";

    public static string Book 
        => "book.jpg";

    public static string Bookplate 
        => "bookplate.jpg";
    ...
    public static string CerealBox 
        => "cerealbox.jpg";

    public static string CerealTypes 
        => "cerealtypes.jpg";

    public static string ChampionshipTypes 
        => "championtypes.jpg";
    ...
    public static string Commissioners 
        => "commissioners.jpg";
    ...
    public static string FigureSpecialtyTypes 
        => "figurespecialtytypes.jpg";

    public static string FirstDayCover 
        => "firstdaycover.jpg";

    public static string Football 
        => "football.jpg";

    public static string FootballTypes 
        => "footballtypes.jpg";

    public static string FranchiseHallOfFameTypes 
        => "franchisehalloffametypes.jpg";

    public static string Franchises 
        => "franchises.jpg";    

    public static string GameStyleTypes 
        => "gamestyletypes.jpg";

    public static string Glove 
        => "glove.jpg";

    public static string GloveTypes 
        => "glovetypes.jpg";
    ...
    public static string HeadBand 
        => "headband.jpg";

    public static string Helmet 
        => "helmet.jpg";

    public static string HelmetFinishes 
        => "helmetfinishes.jpg";

    public static string HelmetQualityTypes 
        => "helmetqualitytypes.jpg";

    public static string HelmetTypes 
        => "helmettypes.jpg";

    public static string HockeyStick 
        => "hockeystick.jpg";
    ...
    public static string InternationalHallOfFameTypes 
        => "internationalhalloffametypes.jpg";
    ...
    public static string JerseyQualityTypes 
        => "jerseyqualitytypes.jpg";

    public static string JerseyStyleTypes 
        => "jerseystyletypes.jpg";

    public static string JerseyTypes 
        => "jerseytypes.jpg";

    public static string LeaderTypes 
        => "leadertypes.jpg";

    public static string LeaguePresidents 
        => "leaguepresidents.jpg";
    ...
    public static string Lithograph 
        => "lithograph.jpg";
    ...
    public static string Pewters 
        => "pewters.jpg";

    public static string Photo 
        => "phototypes.jpg";

    public static string PinFlag 
        => "pinflag.jpg";
    ...
    public static string PriorityTypes 
        => "prioritytypes.jpg";

    public static string PrivacyTypes 
        => "privacytypes.jpg";

    public static string ProjectStatusTypes 
        => "projectstatustypes.jpg";

    public static string ProjectTypes
        => "projecttypes.jpg";

    public static string Puck 
        => "puck.jpg";
    ...
    public static string TeamRoleTypes 
        => "teamroletypes.jpg";

    public static string Teams 
        => "teams.jpg";

    public static string Tennisball 
        => "tennisball.jpg";
