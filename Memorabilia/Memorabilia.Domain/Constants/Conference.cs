...
public sealed class Conference : DomainItemConstant
{
    ...
    public static readonly Conference AmericanConference = new(5, "American Conference");
    public static readonly Conference NFLEasternConference = new(6, "Eastern Conference");
    public static readonly Conference NFLWesternConference = new(7, "Western Conference");
    public static readonly Conference NFLNationalConference = new(8, "National Conference");
