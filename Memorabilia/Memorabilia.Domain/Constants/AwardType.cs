...
{
    public static readonly AwardType ACCBaseballPlayerOfTheYear = new(43, "ACC Baseball Player of the Year", string.Empty);
    ...
    public static readonly AwardType BabeRuthAward = new(38, "Babe Ruth Award", string.Empty);
    public static readonly AwardType BaseballAmericaCollegePlayerOfTheYear = new(52, "Baseball America College Player of the Year", string.Empty);
    ...
    public static readonly AwardType CommissionersHistoricAchievementAward = new(46, "Commissioner's Historic Achievement Award", string.Empty);
    public static readonly AwardType CyYoungAward = new(55, "Cy Young Award", string.Empty);
    public static readonly AwardType DeliveryManOfTheYear = new(41, "Delivery Man of the Year", string.Empty);
    ...
    public static readonly AwardType FordFrickAward = new(49, "Ford C. Frick Award", string.Empty);
    ...
    public static readonly AwardType HeartAndHustleAward = new (51, "Heart and Hustle Award", string.Empty);
    ...
    public static readonly AwardType NationalPitcherOfTheYear = new(45, "National Pitcher of the Year", string.Empty);
    public static readonly AwardType Pac12PitcherOfTheYear = new(53, "Pac-12 Pitcher of the Year", string.Empty);
    ...
    public static readonly AwardType RelieverOfTheYear = new(42, "Reliever of the Year", string.Empty);
    public static readonly AwardType RobertoClementeAward = new(23, "Roberto Clemente Award", string.Empty);
    public static readonly AwardType SECPitcherOfTheYear = new(44, "SEC Pitcher of the Year", string.Empty);
    ...
    public static readonly AwardType TipONeillAward = new(39, "Tip O'Neill Award", string.Empty);
    public static readonly AwardType TonyConigliaroAward = new(50, "Tony Conigliaro Award", string.Empty);
    public static readonly AwardType WillieMacAward = new(54, "Willie Mac Award", string.Empty);
    ...
    private AwardType(int id, string name, string abbreviation) : base(id, name, abbreviation) { }
    ...
    public static AwardType[] GetAll(params int[] sportIds)
    {
        if (!sportIds.Any())
            return All;
