...
public sealed class LeaderType : DomainItemConstant
{
    ...
    public static readonly LeaderType AmericanLeagueStolenBasePercentage = new(155, "American League Stolen Base Percentage");
    ...
    public static readonly LeaderType MajorLeagueBaseballBaseOutWinsAdded = new(183, "Major League Baseball Base-Out Wins Added");
    ...
    public static readonly LeaderType MajorLeagueBaseballHitsAllowed = new(225, "Major League Baseball Hits Allowed");
    ...
    public static readonly LeaderType MajorLeagueBaseballHomeRunsAllowed = new(219, "Major League Baseball Home Runs Allowed");
