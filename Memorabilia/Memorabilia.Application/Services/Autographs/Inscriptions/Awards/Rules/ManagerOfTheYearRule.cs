...
public class ManagerOfTheYearRule : AwardRule, IAwardRule
{
    ...
    public override bool Applies(Constant.AwardType awardType)
    {
        ...
        return awardType == Constant.AwardType.AmericanLeagueManagerOfTheYear ||
               awardType == Constant.AwardType.ManagerOfTheYear ||
               awardType == Constant.AwardType.NationalLeagueManagerOfTheYear;
    }
