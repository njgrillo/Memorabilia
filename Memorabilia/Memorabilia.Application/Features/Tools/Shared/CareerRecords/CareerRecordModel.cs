...
public class CareerRecordModel : PersonSportToolModel
{
    ...
    public CareerRecordModel(CareerRecord careerRecord, Constant.Sport sport)
    {
    ...
    public string CareerRecordTypeName => Constant.RecordType.Find(CareerRecordTypeId)?.Name;
