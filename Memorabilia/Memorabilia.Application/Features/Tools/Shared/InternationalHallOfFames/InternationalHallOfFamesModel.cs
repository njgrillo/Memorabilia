...
public class InternationalHallOfFamesModel
{
    ...
    public InternationalHallOfFamesModel(IEnumerable<InternationalHallOfFame> internationalHallOfFames, Constant.Sport sport)
    {
    ...
    public IEnumerable<InternationalHallOfFameModel> InternationalHallOfFames { get; set; } = Enumerable.Empty<InternationalHallOfFameModel>();
