...
{
    public class SaveSoccerballViewModel : SaveViewModel
    {
        ...
        public ItemType ItemType => ItemType.Soccerball;
        ...
        public override string PageTitle => $"{(MemorabiliaId > 0 ? "Edit" : "Add")} {ItemType.Soccerball.Name} Details";
