...
public class PantEditModel : MemorabiliaItemEditModel
{
    public PantEditModel() 
    { 
    ...
    public PantEditModel(PantModel model)
    {
    ...
    public override string ImageFileName 
        => Constant.ImageFileName.Pants;

    public override Constant.ItemType ItemType 
        => Constant.ItemType.Pants;
}
