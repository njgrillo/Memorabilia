...
{
    public class SaveTicketViewModel : SaveViewModel
    {
        ...
        public ItemType ItemType => ItemType.Ticket;
        ...
        public override string PageTitle => $"{(MemorabiliaId > 0 ? "Edit" : "Add")} {ItemType.Ticket.Name} Details";
