...
public class MemorabiliaItemModel
{
    private readonly Entity.Memorabilia _memorabilia;

    public MemorabiliaItemModel() { }

    public MemorabiliaItemModel(Entity.Memorabilia memorabilia)
    {
    ...
    public List<AutographModel> Autographs 
        => _memorabilia.Autographs.Select(autograph => new AutographModel(autograph)).ToList();
    ...
    public List<Entity.Collection> Collections 
        => _memorabilia.CollectionMemorabilias?.Select(item => item.Collection).ToList() ?? new();
    ...
    public string ImageFileName => !_memorabilia.Images.Any() 
        ...
        : _memorabilia.Images.FirstOrDefault(image => image.ImageTypeId == Constant.ImageType.Primary.Id)?.FileName ?? _memorabilia.Images.First().FileName;

    public List<Entity.MemorabiliaImage> Images => _memorabilia.Images;
    ...
    public IEnumerable<Entity.MemorabiliaPerson> People => _memorabilia.People;

    public int? PrimaryAutographId => _memorabilia.Autographs.FirstOrDefault()?.Id;

    public string PrimaryAutographImageName => HasAutographs 
    ...
    public IEnumerable<Entity.MemorabiliaSport> Sports => _memorabilia.Sports;

    public IEnumerable<Entity.MemorabiliaTeam> Teams => _memorabilia.Teams;
