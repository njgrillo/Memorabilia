...
{
    public class SavePuckViewModel : SaveViewModel
    {
        ...
        public ItemType ItemType => ItemType.Puck;
        ...
        public override string PageTitle => $"{(MemorabiliaId > 0 ? "Edit" : "Add")} {ItemType.Puck.Name} Details";
