...
public class ProjectMemorabiliaTeamViewModel
{
    private readonly ProjectMemorabiliaTeam _projectMemorabiliaTeam;

    public ProjectMemorabiliaTeamViewModel() { }

    public ProjectMemorabiliaTeamViewModel(ProjectMemorabiliaTeam projectMemorabiliaTeam)
    {
