...
public class CollegeRetiredNumberEditModel : EditModel
{
    public CollegeRetiredNumberEditModel()
    {
        TemporaryId = Guid.NewGuid();
    }

    public CollegeRetiredNumberEditModel(Entity.CollegeRetiredNumber retiredNumber)
    {
        CollegeId = retiredNumber.CollegeId;
        Id = retiredNumber.Id;
    ...
    public CollegeRetiredNumberEditModel(int id, int personId, string playerNumber)
    {
        Id = id;
        PersonId = personId;
