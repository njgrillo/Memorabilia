...
#nullable disable
#nullable restore
#line 3 "C:\Projects\Memorabilia\Memorabilia\Memorabilia.Web\Pages\Admin\AuthenticationCompanies\EditBill.razor"
using Budget.Application.Features.Bill;

#line default
#line hidden
#nullable disable
#nullable restore
#line 4 "C:\Projects\Memorabilia\Memorabilia\Memorabilia.Web\Pages\Admin\AuthenticationCompanies\EditBill.razor"
using Budget.Domain.Constants;

#line default
#line hidden
#nullable disable
    [Microsoft.AspNetCore.Components.RouteAttribute("/Bills/Edit/{id:int}")]
    public partial class EditBill : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 67 "C:\Projects\Memorabilia\Memorabilia\Memorabilia.Web\Pages\Admin\AuthenticationCompanies\EditBill.razor"
       
    [Parameter]
    public int Id { get; set; }

    private SaveBillViewModel _viewModel = new SaveBillViewModel();

    protected async Task HandleValidSubmit()
    {
        var command = new SaveBill.Command(_viewModel);

        await _commandRouter.Send(command).ConfigureAwait(false);

        _navigation.NavigateTo("Bills");

        _toastService.ShowSuccess("Bill was saved successfully!", _viewModel.PageTitle);
    }

    protected override async Task OnInitializedAsync()
    {
        var query = new GetBill.Query(Id);

        _viewModel = new SaveBillViewModel(await _queryRouter.Send(query).ConfigureAwait(false));
    }
