...
#nullable disable
#nullable restore
#line 3 "C:\Projects\Memorabilia\Memorabilia\Memorabilia.Web\Pages\Admin\AuthenticationCompanies\Bills.razor"
...
#nullable disable
    ...
    public partial class Bills : Microsoft.AspNetCore.Components.ComponentBase
    {
...
#nullable restore
#line 86 "C:\Projects\Memorabilia\Memorabilia\Memorabilia.Web\Pages\Admin\AuthenticationCompanies\Bills.razor"
       
    private PopConfirm _deleteDialog;
    private int _deletedItemId;
    private bool _maskCurrency;
    ...
    protected async Task Delete(bool confirm)
    {
        ...
        var viewModel = new SaveBillViewModel(_viewModel.Bills.Single(bill => bill.Id == _deletedItemId));
        viewModel.IsDeleted = true;

        var command = new SaveBill.Command(viewModel);

        await _commandRouter.Send(command).ConfigureAwait(false);
        await OnInitializedAsync().ConfigureAwait(false);

        _toastService.ShowSuccess("Bill was deleted successfully!", _viewModel.PageTitle);
    }

    protected void Edit(int id)
    {
        _navigation.NavigateTo($"Bills/Edit/{id}");
    }
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        _maskCurrency = (await _localStorage.GetAsync<bool>("MaskCurrency")).Value;

        var query = new GetBills.Query(userId.Value);
