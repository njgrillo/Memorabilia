...
namespace Memorabilia.Web.Pages.Admin.AcquisitionTypes
{
    public partial class EditAcquisitionType : ComponentBase
    {
        ...
        private const string DomainTypeName = "Acquisition Type";
        private const string ImagePath = "images/acquisitiontypes.jpg";
        ...
        {
            _viewModel = new SaveDomainViewModel(await QueryRouter.Send(new GetAcquisitionType.Query(Id)).ConfigureAwait(false),
                                                 DomainTypeName,
                                                 ImagePath,
                                                 _navigationPath);
        }
        ...
        {
            await CommandRouter.Send(new SaveAcquisitionType.Command(_viewModel)).ConfigureAwait(false);
        }
    }
}
