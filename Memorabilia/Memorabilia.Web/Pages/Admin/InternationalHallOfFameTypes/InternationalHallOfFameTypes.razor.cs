...
{
    public partial class InternationalHallOfFameTypes : ComponentBase
    {
        [Inject]
        ...
        private InternationalHallOfFameTypesViewModel _viewModel;
        ...
        {
            _viewModel = await QueryRouter.Send(new GetInternationalHallOfFameTypes.Query()).ConfigureAwait(false);
        }
    }
}
