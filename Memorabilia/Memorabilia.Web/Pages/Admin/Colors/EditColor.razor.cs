...
namespace Memorabilia.Web.Pages.Admin.Colors
{
    public partial class EditColor : ComponentBase
    {
        ...
        private const string DomainTypeName = "Color";
        private const string ImagePath = "images/colors.jpg";
        ...
        {
            _viewModel = new SaveDomainViewModel(await QueryRouter.Send(new GetColor.Query(Id)).ConfigureAwait(false),
                                                 DomainTypeName,
                                                 ImagePath,
                                                 _navigationPath);
        }
        ...
        {
            await CommandRouter.Send(new SaveColor.Command(_viewModel)).ConfigureAwait(false);
        }
    }
}
